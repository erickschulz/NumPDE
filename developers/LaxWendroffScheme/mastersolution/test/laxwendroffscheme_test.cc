...
TEST(LaxWendroffScheme, numexpLaxWendroffRP) {
  ...
  diffL1_ref << 0.11292791267119, 0.0603705513757616, 0.0398865560657988, 0.0165072409858187, 0.00846189295708334, 0.0053167573498566;
